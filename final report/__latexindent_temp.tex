...
The only attribute from $DetectFaceResult$ that is in our interest is the UUID of the detected person, since we only want to compare the appearance of two people.\\
